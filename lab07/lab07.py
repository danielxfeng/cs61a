...
class Person:
    ...
    def repeat(self):
        return self.say(self.last_said)
...
class SmartFridge:
    ...
    def use_item(self, item, quantity):
        ...
        balance = self.items[item]
        if balance == 0:
            return_string = f"Oh no, we need more {item}!"
        else:
            return_string = f"I have {balance} {item} left"
...
class Round:
    ...
    def play(self, who, card):
        ...
        self.next_player = 0 if who == self.players - 1 else who + 1
...
import doctest
doctest.run_docstring_examples(amplify, globals())
doctest.run_docstring_examples(Person, globals())
doctest.run_docstring_examples(SmartFridge, globals())
doctest.run_docstring_examples(CucumberGame, globals())
