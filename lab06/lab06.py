...
import doctest
doctest.run_docstring_examples(insert_items, globals())
doctest.run_docstring_examples(count_occurrences, globals())
doctest.run_docstring_examples(repeated, globals())
doctest.run_docstring_examples(partial_reverse, globals())
doctest.run_docstring_examples(index_largest, globals())
doctest.run_docstring_examples(pizza_sort, globals())
