...
import doctest
doctest.run_docstring_examples(total_weight, globals())
doctest.run_docstring_examples(balanced, globals())
doctest.run_docstring_examples(totals_tree, globals())
doctest.run_docstring_examples(replace_loki_at_leaf, globals())
doctest.run_docstring_examples(has_path, globals())
