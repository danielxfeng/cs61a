...
# doctest.run_docstring_examples(accumulate, globals())
# doctest.run_docstring_examples(summation_using_accumulate, globals())
# doctest.run_docstring_examples(product_using_accumulate, globals())
# doctest.run_docstring_examples(funception, globals())
# doctest.run_docstring_examples(mul_by_num, globals())
# doctest.run_docstring_examples(mod_maker, globals())
# doctest.run_docstring_examples(add_results, globals())