...
class VendingMachine:
    ...
    'Here is your soda.'
    """
    OUT_OF_STOCK = "Nothing left to vend. Please restock."
    ...
    def vend(self):
        ...
        self.stock -= 1
        ret = f"Here is your {self.item}."
        if self.balance > self.price:
            ret = ret[:-1] + f" and ${self.balance - self.price} change."
        self.balance = 0
        return ret
        
    def add_funds(self, amount):
        if not self.stock:
            return self.OUT_OF_STOCK + f" Here is your ${amount}."
        self.balance += amount
...
class Player:
    ...
    def speech(self, other):
        ...
        self.votes += gain
        loss = other.popularity // 10
        other.popularity -= loss
        self.popularity = max(self.popularity, 0)
        other.popularity = max(other.popularity, 0)
...
import doctest
doctest.run_docstring_examples(Mint, globals())
doctest.run_docstring_examples(VendingMachine, globals())
doctest.run_docstring_examples(Player, globals())
doctest.run_docstring_examples(Game, globals())
doctest.run_docstring_examples(AggressivePlayer, globals())
doctest.run_docstring_examples(CautiousPlayer, globals())
doctest.run_docstring_examples(VirFib, globals())
