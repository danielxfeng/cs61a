...
def count_palindromes(L):
    ...
    def ispld(word):
        for i in range(len(word) // 2):
            if word.lower()[i] != word.lower()[-1 * i - 1]:
                return 0
        return 1

    return sum([ispld(x) for x in L])
...
# doctest.run_docstring_examples(my_map, globals())
# doctest.run_docstring_examples(my_filter, globals())
# doctest.run_docstring_examples(my_reduce, globals())
# doctest.run_docstring_examples(distance, globals())
# doctest.run_docstring_examples(closer_city, globals())
# doctest.run_docstring_examples(count_palindromes, globals())
# doctest.run_docstring_examples(coords, globals())
