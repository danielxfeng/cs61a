...
import doctest
doctest.run_docstring_examples(insert_into_all, globals())
doctest.run_docstring_examples(subseqs, globals())
doctest.run_docstring_examples(non_decrease_subseqs, globals())
doctest.run_docstring_examples(num_trees, globals())
doctest.run_docstring_examples(partition_gen, globals())
doctest.run_docstring_examples(trade, globals())
doctest.run_docstring_examples(shuffle, globals())
doctest.run_docstring_examples(insert, globals())
doctest.run_docstring_examples(deep_len, globals())
doctest.run_docstring_examples(make_to_string, globals())
doctest.run_docstring_examples(reverse_other, globals())
