...
import doctest
doctest.run_docstring_examples(paths, globals())
doctest.run_docstring_examples(reverse, globals())
doctest.run_docstring_examples(widest_level, globals())
doctest.run_docstring_examples(in_order_traversal, globals())
doctest.run_docstring_examples(deep_map, globals())
